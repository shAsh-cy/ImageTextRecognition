...
def main(args):
    ...
    pred_model_save_path = args.save_path.replace(".h5", "_prediction.h5")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", default="sampled_data", help="Path to the directory containing images (from the notebook)")
    parser.add_argument("--epochs", type=int, default=50, help="Number of epochs to train")
    parser.add_argument("--batch_size", type=int, default=32, help="Batch size for training")
    parser.add_argument("--lr", type=float, default=0.001, help="Learning rate for Adam optimizer")
    parser.add_argument("--save_path", default="models/crnn_best_weights.h5", help="Path to save the best model weights")
